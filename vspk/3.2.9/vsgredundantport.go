...
// EventLogs retrieves the list of child EventLogs of the VsgRedundantPort
func (o *VsgRedundantPort) EventLogs(info *bambou.FetchingInfo) (EventLogsList, *bambou.Error) {
